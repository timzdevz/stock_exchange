...
<!--			<p>--><?php //_e( 'Registering for this site is easy. Just fill in the fields below, and we\'ll get a new account set up for you in no time.', 'buddypress' ); ?><!--</p>-->
			...
			<div class="submit">
				<input type="submit" name="signup_submit" id="signup_submit" value="<?php esc_attr_e( 'Complete Sign Up', 'buddypress' ); ?>"  class="woo-sc-button teal"/>
			</div>
		...
		<?php if ( 'completed-confirmation' == bp_get_current_signup_step() ) : ?>
			...
			<div id="template-notices" role="alert" aria-atomic="true">
				<?php if ( bp_registration_needs_activation() ) : ?>
                    ...
                    <p>Вы успешно создали вашу учетную запись. <br>Для ее активации вам необходимо <strong>перейти по ссылке из письма</strong>, которое мы только что отправили на <b><?php echo esc_html( $_POST['signup_email'] ) ?></b>. <br>После этого вы сможете авторизовываться и полноценно пользоваться сайтом.</p>

                    <?php echo get_resend_activation_link( $_POST['signup_username'] ); ?>

                    <p>Возникли трудности с активацией? <a href="<?php echo home_url('/contacts') ?>">Напишите нам</a> и мы активируем ваши учетную запись!</p>
