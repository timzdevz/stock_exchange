...
<?php if ( bp_has_notifications() ) : ?>
    ...
    <form action="" method="post">
        <input type="hidden" name="unread_notification_action" value="true">
        <?php wp_nonce_field('stockexchange-notification-action' . bp_displayed_user_id() ); ?>
        <button name="delete-all-unread">Удалить все непрочитанные</button>
        <button name="mark-all-read">Отметить все как прочитанные</button>
    </form>
